(function () {
  ...
  Game.prototype.restart = function (ctx) {
    ...
    ctx.fillStyle = "white";
    ctx.fillText("You lose, press 'enter'", this.DIM_X/4, this.DIM_Y/3);
    ctx.font = "36px fantasy";
    ctx.fillStyle = "white";
    ctx.fillText("to try again. Score: " + this.score, this.DIM_X/4, this.DIM_Y/3 + 50);
    this.asteroids = [];
    this.bullets = [];
    this.score=0;
    this.lives=3;
  ...
  Game.prototype.advanceLevel = function (ctx) {
    ...
    ctx.font = "36px fantasy";
    ctx.fillStyle = "white";
    ctx.fillText("Prepare for level " + this.level, this.DIM_X/4, this.DIM_Y/3);
    ctx.font = "36px fantasy";
    ctx.fillStyle = "white";
    ctx.fillText("Press 'enter' to continue", this.DIM_X/4, this.DIM_Y/3+50);
  }
